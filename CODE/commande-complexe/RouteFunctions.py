...
def FindTarget (Advance_Data,Speed):
    ...
    Rimpact=1 #distance before impact
    ...
    if Positions[0][5]<0:
        direction=-1
    return([Positions[0][4],Positions[0][5]],10000,direction,reverse,Positions[int(90/360*parameters.Lidar_steps)][2])
...
def ReverseTrajectory(speed,target,direction):
    ...
    T=10 #horizon de prévision en secondes
    nb=20 #nb de pts que comporte la trajectoire (plus on en a plus c'est précis) 
